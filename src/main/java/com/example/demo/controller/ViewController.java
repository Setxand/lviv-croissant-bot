...
public class ViewController {
	...
	@Autowired RecognizeService recognizeService;
	@Autowired CustomerOrderingRepositoryService customerOrderingRepositoryService;
	@Autowired CroissantRepositoryService croissantRepositoryService;
